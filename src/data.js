...
export const PRODUCTS = [
  {
    ...
    highlights: [
      ...
      { icon: "water", label: "Tanks", value: "70 L" },
      { icon: "clock", label: "Runtime", value: "4–6 hours" },
      { icon: "weight", label: "Cleaning width", value: "550 mm" },
    ],
    ...
    features: [
      ...
      "High-capacity 70 L solution and recovery tanks",
  ...
  },
  {
    ...
    highlights: [
      ...
      { icon: "water", label: "Tanks", value: "25 L" },
  ...
  },
  {
    ...
    blurb:
      "A new class of thinking machine. Currently in development at our Kochi studio.",
    highlights: [],
    for: "",
  },
  {
...
export const INDUSTRIES = [
  {
    ...
    desc: "Spotless concourses and platforms, even at peak passenger flow.",
  },
  {
    name: "Shopping Malls",
    desc: "Continuous floor care across vast retail floors without disruption.",
  },
  {
    name: "Hospitals & Clinics",
    desc: "Consistent hygiene where cleanliness is mission-critical.",
  },
  {
    name: "Warehouses & Factories",
    desc: "Durable automation for demanding industrial environments.",
  },
];
